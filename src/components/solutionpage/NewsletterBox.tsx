...
export default function NewsletterBox() {
  ...
  return (
    <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
      <h3 className="text-lg font-bold text-[#041740] mb-3">Stay Updated</h3>
      ...
      <form onSubmit={handleSubscribe} className="space-y-3">
        <input
          ...
          className="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#041740] text-sm"
          required
        />
        <button
          type="submit"
          className="w-full bg-[#041740] hover:bg-[#0d4175] text-white font-medium py-3 px-4 rounded-lg transition duration-200"
        >
          Subscribe
        </button>
        ...
        {subscribed && (
          <div className="mt-4 px-4 py-3 bg-[#df0c0c] bg-opacity-20 rounded-md border-l-4 border-[#df0c0c] animate-fade-in">

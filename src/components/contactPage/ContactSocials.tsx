...
export default function ContactSocials({ block }: ContactSocialsProps) {
  ...
  return (
    <section className="py-16 bg-[#041740] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold mb-4">Connect With Us</h2>
          <div className="w-20 h-1 bg-[#df0c0c] mx-auto"></div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 transform transition hover:translate-y-1 hover:shadow-lg">
            <div className="flex items-center justify-center bg-[#df0c0c] w-14 h-14 rounded-lg -mt-10 mb-4 mx-auto shadow-md">
              <Globe className="w-7 h-7 text-[#041740]" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {socialLinks.twitter && (
                ...
                >
                  <Twitter className="mr-2 text-[#df0c0c]" size={20} />
              ...
              {socialLinks.linkedin && (
                <a
                  ...
                  className="flex items-center justify-center bg-white/10 hover:bg-white/20 p-3 rounded-lg transition-all duration-300"
                >
                  <Linkedin className="mr-2 text-[#df0c0c]" size={20} />
              ...
              {socialLinks.instagram && (
                <a
                  ...
                  className="flex items-center justify-center bg-white/10 hover:bg-white/20 p-3 rounded-lg transition-all duration-300"
                >
                  <Instagram className="mr-2 text-[#df0c0c]" size={20} />
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 transform transition hover:translate-y-1 hover:shadow-lg">
            <div className="flex items-center justify-center bg-[#df0c0c] w-14 h-14 rounded-lg -mt-10 mb-4 mx-auto shadow-md">
              <Phone className="w-7 h-7 text-[#041740]" />
            </div>
            ...
            <div className="space-y-4">
                ...
                block.phoneNumbers.map(({ phone }, i) => (
                  ...
                  >
                    <div className="flex items-center">
                      <Phone size={18} className="text-[#df0c0c] mr-3" />
                      <span className="font-medium">{phone}</span>
                    </div>
                    <a
                      href={`tel:${phone.replace(/\D/g, '')}`}
                      className="bg-[#df0c0c] text-[#041740] font-medium px-3 py-1 rounded-md hover:bg-opacity-90 transition-opacity duration-300"
                    >
                      Call
                    </a>
                  </div>
              ...
              <div className="bg-white/10 p-4 rounded-lg mt-4">
                <div className="flex items-center">
                  <Clock size={18} className="text-[#df0c0c] mr-3" />
                  <div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 transform transition hover:translate-y-1 hover:shadow-lg">
            <div className="flex items-center justify-center bg-[#df0c0c] w-14 h-14 rounded-lg -mt-10 mb-4 mx-auto shadow-md">
              <Mail className="w-7 h-7 text-[#041740]" />
            </div>
                ...
                block.emailAdd.map(({ email }, i) => (
                  ...
                  >
                    <Link href={`mailto:${email}`} className="">
                      <div className="flex items-center">
                        <Mail size={18} className="text-[#df0c0c] mr-3" />

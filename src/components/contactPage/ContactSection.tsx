...
export default function ContactForm({ block }: ContactBlock) {
  ...
  if (!formData)
    return (
      <section className="max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        <div className="bg-[#041740] border border-[#df0c0c] rounded-lg p-6 sm:p-8 text-center flex flex-col items-center space-y-4 shadow-md max-w-md mx-auto">
  ...
  if (success)
    return (
      <section className="max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        <div className="bg-white border-l-4 border-[#df0c0c] rounded-lg p-8 text-center shadow-lg">
          <div className="bg-[#df0c0c] rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6">
            <svg
              className="w-8 h-8 text-[#041740]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <h3 className="text-2xl font-bold text-[#041740] mb-3">Thank You!</h3>
          <p className="text-gray-600 mb-4">
            Your message has been received. We{"'"}ll be in touch shortly.
          </p>
          <button
            onClick={() => setSuccess(false)}
            className="inline-flex items-center px-4 py-2 bg-[#041740] text-white rounded-md hover:bg-[#0f4579] transition duration-150"
          >
    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-8 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-[#041740] mb-4">Get In Touch</h2>
          <div className="w-24 h-1 bg-[#df0c0c] mx-auto mb-4"></div>
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden">
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-6 sm:p-10">
              <h3 className="text-2xl font-semibold text-[#041740] mb-6">Send Us a Message</h3>
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div key={field.id} className="relative col-span-2 md:col-span-1">
                            ...
                            <div className="relative">
                              ...
                              <input
                                ...
                                className="block w-full pl-10 px-4 py-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#041740] focus:border-transparent transition duration-150"
                        ...
                        return (
                          <div key={field.id} className="relative col-span-2">
                            ...
                            <textarea
                              ...
                              required={field.required}
                              rows={4}
                              className="block w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#041740] focus:border-transparent transition duration-150"
                ...
                <div className="pt-2 col-span-2">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full px-6 py-3 bg-[#041740] hover:bg-[#041740e1] text-white font-medium rounded-md shadow-sm transition duration-150 flex items-center justify-center cursor-pointer"
                  >
                    {submitting ? (
                      <>
                        <svg
            ...
            <div className="bg-[#041740] text-white p-6 sm:p-10 flex flex-col justify-center items-center gap-8">
              ...
              <div className="mb-8">
                ...
                <div className="w-16 h-1 bg-[#df0c0c] mb-6"></div>

...
export default async function TeamDescription({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <section className="bg-white min-h-screen relative overflow-hidden py-20">
      {/* Background elements */}
      <div className="absolute top-0 left-0 w-full h-64 bg-gradient-to-r from-[#041740] to-[#7aa4c3] transform -skew-y-2 origin-top-left"></div>
      <div className="absolute top-64 right-0 w-48 h-48 rounded-full bg-[#df0c0c] blur-xl opacity-50"></div>
      <div className="absolute bottom-64 left-0 w-64 h-64 rounded-full bg-[#df0c0c] blur-3xl opacity-30"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mt-12">
          ...
          <div className="lg:col-span-5 xl:col-span-4">
            <div className="sticky top-8">
              <div className="relative">
                <div className="absolute -top-2 -left-2 w-16 h-16 text-[#df0c0c]">
                  <svg viewBox="0 0 100 100" fill="currentColor">
                    <path d="M50 0L93.3 25L93.3 75L50 100L6.7 75L6.7 25Z"></path>
                  </svg>
                </div>
                <div className="absolute -bottom-2 -right-2 w-16 h-16 text-[#041740]">
                  <svg viewBox="0 0 100 100" fill="currentColor">
                    <path d="M50 0L93.3 25L93.3 75L50 100L6.7 75L6.7 25Z"></path>
                  </svg>
                </div>
                ...
                <div className="relative z-10 rounded-lg overflow-hidden border-4 border-white shadow-xl mb-6 aspect-[3/4]">
                  ...
                  />
                  <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-[#041740] to-transparent"></div>
                </div>
              </div>

              <div className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-[#df0c0c]">
                <h1 className="text-2xl md:text-3xl font-bold text-[#041740] mb-2">
                  {team_member.name}
                </h1>
                <p className="text-[#7aa4c3] text-lg mb-4">{team_member.role}</p>

                <div className="flex items-center mb-4 text-[#041740]">
                ...
                <div className="space-y-3 mt-6">
                  <a
                    ...
                    className="flex items-center text-[#041740] hover:text-[#df0c0c] transition-colors"
                  >
                    <div className="bg-[#df0c0c] p-2 rounded-lg mr-3">
                ...
                <div className="mt-8">
                  <h3 className="text-[#041740] font-medium mb-4">Connect</h3>
                  <div className="flex space-x-3">
                    {team_member.linkedin && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="p-2 bg-[#f0f4f8] rounded-lg text-[#041740] hover:bg-[#041740] hover:text-white transition-colors"
          ...
          <div className="lg:col-span-7 xl:col-span-8">
            <div className="bg-white rounded-xl shadow-lg p-8 mb-12 relative overflow-hidden">
              <div className="absolute -top-20 -right-20 w-40 h-40 bg-[#df0c0c]/20 rounded-full"></div>
              <div className="absolute -bottom-12 -left-12 w-24 h-24 bg-[#df0c0c]/10 rounded-full"></div>

              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl font-bold text-[#041740] mb-6">
            ...
            {relatedMembers.length > 0 && (
              <div>
                <h3 className="text-xl font-bold text-[#041740] mb-6">Team Members</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                  {relatedMembers.map((member, index) => (
                    <Link key={index} href={`/team/${member.slug}`} className="group">
                      <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 border-b-2 border-[#df0c0c]">
                        <div className="relative h-52">
                          <Image
                            ...
                            className="object-cover"
                          />
                          <div className="absolute inset-0 bg-gradient-to-t from-[#041740] via-[#041740]/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-6">
                            <span className="text-white font-medium">View Profile</span>
                          </div>
                        </div>
                        <div className="p-4">
                          <h4 className="font-bold text-[#041740] group-hover:text-[#7aa4c3] transition-colors duration-300">
                            {member.name}
                          </h4>
